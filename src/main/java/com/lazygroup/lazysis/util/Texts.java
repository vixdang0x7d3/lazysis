...
public class Texts {
	 ...
	 *
	 * @param contents   Observable String Value to be bound to the Text property of
	 *                   the Text
	 ...
	 *
	 * @param contents Observable String Value to bind to the Text property of the
	 *                 DataText
	...
	public static TextField fixedDecimalField(Property<Double> boundProperty, int decimalPlaces, double maxWidth) {
		...
		TextFormatter<Double> textFormatter = new TextFormatter<>(new FixedDecimalConverter(decimalPlaces),
				boundProperty.getValue(), new FixedDecimalFilter(decimalPlaces));
	...
	public static TextField integerField(Property<Integer> boundProperty, double maxWidth) {
		TextField results = new TextField();
		results.setMaxWidth(maxWidth);
		TextFormatter<Integer> textFormatter = new TextFormatter<>(integerStringConverter(),
				boundProperty.getValue(), new IntegerFilter());
		results.setTextFormatter(textFormatter);
		boundProperty.bindBidirectional(textFormatter.valueProperty());
		return results;
	}
